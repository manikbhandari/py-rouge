...
def run_perl_rouge_script(hyps, refs, rouge_dir, metrics, N, stemming, apply_avg, apply_best, alpha, limit_length, length_limit_type, length_limit, tmp_folder='/Users/mbhandari/tmp'):
...
def run_a_single_t_est(rouge_dir, metrics, N, stemming, apply_avg, apply_best, alpha, limit_length, length_limit_type, length_limit, weight_factor=1.0, tmp_folder='/Users/mbhandari/tmp'):
    results = {}
...
def run_a_single_t_est_on_all_files_rouge_n(metrics, N, alpha, apply_avg, apply_best, length_limit, length_limit_type, limit_length, rouge_dir, stemming, epsilon_ngrams_count_and_hits, epsilon_avg_with_resampling):
    results = run_a_single_t_est(rouge_dir, metrics, N, stemming, apply_avg, apply_best, alpha, limit_length, length_limit_type, length_limit, tmp_folder='/Users/mbhandari/tmp_rouge_n')
...
def run_a_single_t_est_on_all_files_rouge_l(metrics, N, alpha, apply_avg, apply_best, length_limit, length_limit_type, limit_length, rouge_dir, stemming, epsilon_ngrams_count_and_hits, epsilon_avg_with_resampling):
    results = run_a_single_t_est(rouge_dir, metrics, N, stemming, apply_avg, apply_best, alpha, limit_length, length_limit_type, length_limit, tmp_folder='/Users/mbhandari/tmp_rouge_l')
...
def run_a_single_t_est_on_all_files_rouge_w(metrics, N, alpha, apply_avg, apply_best, length_limit, length_limit_type, limit_length, rouge_dir, stemming, weight_factor, epsilon_ngrams_count_and_hits, epsilon_avg_with_resampling):
    results = run_a_single_t_est(rouge_dir, metrics, N, stemming, apply_avg, apply_best, alpha, limit_length, length_limit_type, length_limit, weight_factor, tmp_folder='/Users/mbhandari/tmp_rouge_w')
